package de.mhsgr.po.AddNewNamespace;
...
public class AddNewNamespace extends AbstractTransformation {
	...
	public void transform (TransformationInput transformationInput, TransformationOutput transformationOutput) throws StreamTransformationException {
		...
		String ns = transformationInput.getInputParameters().getString("ns");
		String prefix = transformationInput.getInputParameters().getString("prefix");
		...
		try {
			...
			Element destElement  = dest.createElement(prefix + ":" + rootNode.getNodeName());

			destElement.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:" + prefix, ns);
			
			Element newDocumentElement = dest.createElementNS(ns, rootNode.getNodeName());
